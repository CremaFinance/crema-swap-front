...
export interface FarmInfo {
  ...
  user?: object
  stakeUserListAccount?: string
  liquidityUsdValue?: any
}
...
export const FARMS: FarmInfo[] = [
  ...
  // {
  //   name: 'LPFARMTEST1',
  //   lp: { ...LP_TOKENS['STAKE-LPTOKEN1'] },
  //   reward: { ...TOKENS.REWARDLPTOKEN1 },
  //   isStake: false,
  //   fusion: false,
  //   legacy: true,
  //   dual: false,
  ...
  //   poolId: '4UrXGePr2iViQCcZcTpBZ9VpfxdmN6yczXggp8ecirvb',
  //   poolAuthority: 'D1eJdXS4ZSEJybAcSs6rffAwY4tNSMG5UEPYJQ4bczbd',
  //   poolLpTokenAccount: '3okaVMyY1TV7HEP55eBPokSG5o88k3QFAp6ERkqsGDhb', // lp vault
  //   poolRewardTokenAccount: 'AY1bB8RvXAVv82uFWZCofLQyd9YZkoL1CbW4Jz3AsmiW', // reward vault
  //   stakeUserListAccount: '9LSajQvhm25JEqWLUqDreoQKt6VZXn7KKFomareK5dAs'
  // },
  // {
  //   name: 'HYSD-USDD',
  ...
  //   version: 3,
  //   programId: STAKE_PROGRAM_ID,
  //   poolId: 'C6ycMGgZgq9q5MxeEbXDJ1eyokuGvhAGCy4mA33owfHa', // stake pool account
  //   poolAuthority: 'FXMR1r2bQwy2FgNhnVYnQT6yCYvhjAuT8z351jz787nD',
  //   poolLpTokenAccount: 'C3PgXLcj5fNDGPs3XXPWJmNuL5cqznq6bNvyWL9Uj7NG', // lp vault
  //   poolRewardTokenAccount: 'Gz8aRPQRdxQgGm2kqQaNktMJMhBje41TsPYtkuwBnuP', // reward vault
  //   stakeUserListAccount: '4gYzddJb6GLqPtYPHSWuLhrk2WfNoe9Cog5bAEuyuVXt' // stake user list account
  // },
  {
    name: 'HYSD-USDD',
    lp: { ...LP_TOKENS['HYSD-USDD'] },
    ...
    version: 3,
    programId: STAKE_PROGRAM_ID,
    // poolId: 'AKfPCvVa1GRq4eSgpV6qZ7AFFUoTzzwtTJPUyJiBttCc', // stake pool account
    poolId: 'AkrmPyGRUZ8YenwJ6U8wAm5DCcCyWyw4W9LuCvb7MyGt', // stake pool account
    // poolAuthority: '5iEGR4qrJTF9K4U96eMMxN5YAM5FvzGkkYhA4DhtDEez',
    poolAuthority: 'EtdFXDRd2Mqb2Gp6NhnxzZmpox93Nzn89XbpXDHJFoRm',
    // poolLpTokenAccount: '7q39FeE2DnRRRnv38cBvugYZuhS8HbxvP5wBTPLcTdLW', // lp vault
    poolLpTokenAccount: '8JANkurFhRDmZeJrjwbzSiRAwgLMP4Z77Y7nymxuwyaM', // lp vault
    // poolRewardTokenAccount: '8wGhpp9vwYbVgcvGhmvAToAWdDRSrqZxTRJqUxKzCzoJ', // reward vault
    poolRewardTokenAccount: '6MncqTMSGppdVQa3ywQ1WAowwaeZxwPXPzKh6tQMuATt', // reward vault
    // stakeUserListAccount: 'APPAZcPDx3JS2GGJdVx1uQD4KhLZZUgVJDYcwMivtXr3' // stake user list account
    stakeUserListAccount: 'EjYcHHgMJqLwiDTn3aKENmxP2dMQFMXHeJdJSs1qpxae' // stake user list account
  },
  // v3
  // {
  //   name: 'RAY-WUSDT',
  ...
  // {
  //   name: 'STAKETEST1',
  //   lp: { ...TOKENS.STAKETOKEN1 },
  //   reward: { ...TOKENS.STAKETOKEN2 },
  //   isStake: true,
  //   fusion: false,
  //   legacy: false,
  //   dual: false,
  //   version: 2,
  //   programId: STAKE_PROGRAM_ID,
  //   poolId: 'Gp8BofcgVN1VExYWsw5BAhK1nF7Gw2Nc3zP3b2AJMfzU', // stake pool account
  //   poolAuthority: 'DtmmeUpmkLuaJK9vhaCBZJ8EVmM5YcabQCNHCQd8yLxH',
  //   poolLpTokenAccount: '4vZERjw4ZdkWoomKdQnTPFCg1utneivwoaZbdfn4LPpm', // lp vault
  //   // poolRewardTokenAccount: 'FxcPwRQkMHZ8G4TSd1V4hrptiEVs4MemSo7jzadqC8zm' // reward vault
  //   poolRewardTokenAccount: 'BTe4GwJFKB6D2EYJECn4NNVGUPFSoAdUKPvymY23cHwD', // reward vault
  //   stakeUserListAccount: 'J7dnXpEVBjyj5YvoEGQaK2MFdodPWsiRNQDM7nLqNgJC' // stake user list account
  // },
  {
    name: 'HYSD',
    lp: { ...TOKENS.HYSD },
    ...
    version: 2,
    programId: STAKE_PROGRAM_ID,
    poolId: '2Fzp5qnS4T6iVcTSs87WsJNYaVuMrYuPEpRzceeNrDg6',
    poolAuthority: '6sugxi9WJ38iR5XMKQHvHUafjPjwmAbiC5a4YLKzqGSF',
    poolLpTokenAccount: 'GAKibRoq9ERZXgd523rXBYNzHtpCQFKg3rdbTxVKcKYD', // lp vault
    poolRewardTokenAccount: 'DckbDDbRKxzqubHGGSYx7ATKBvi44i4wt38MppY7ormM', // reward vault
    stakeUserListAccount: 'EPRgp9jnhVdijzbfbJCoXriTLUCm2L13tQhPeRYVKfXz'
  }
  // {
  //   name: 'STAKETEST1',
  //   lp: { ...TOKENS.STAKETOKEN1 },
  ...
  //   version: 2,
  //   programId: STAKE_PROGRAM_ID,
  //   poolId: 'Gp8BofcgVN1VExYWsw5BAhK1nF7Gw2Nc3zP3b2AJMfzU',
  //   poolAuthority: 'DtmmeUpmkLuaJK9vhaCBZJ8EVmM5YcabQCNHCQd8yLxH',
  //   poolLpTokenAccount: '4vZERjw4ZdkWoomKdQnTPFCg1utneivwoaZbdfn4LPpm', // lp vault
  //   poolRewardTokenAccount: 'FxcPwRQkMHZ8G4TSd1V4hrptiEVs4MemSo7jzadqC8zm' // reward vault
  // }
