      ...
      <div class="echarts-chart">
        <div class="chart-all">
          <div class="chart-title">
            <div class="chart-title-left">
              ...
              <p>$&nbsp;<Spin v-if="!TotalValue && !wdAll.TotalValue" size="small"/><span>{{ TotalValue ? TotalValue : wdAll.TotalValue }}</span></p>
            </div>
        ...
        <div class="chart-spec">
          <div class="chart-spec-vol">
            ...
            <p>$&nbsp;<Spin v-if="!wdAll.Vol" size="small"/><span>{{ wdAll.Vol }}</span></p>
          </div>
          <div class="chart-spec-tra">
            <p>Cumulative Transactions</p>
            <p><Spin v-if="!wdAll.Tra" size="small"/><span>{{ wdAll.Tra }}</span></p>
          </div>
        </div>
      </div>
        ...
        <div class="chart-all">
          <div class="chart-title">
            <div class="chart-title-left">
              ...
              <p>$&nbsp;<Spin v-if="!TradingVolume && !wdAll.TradingVolume" size="small"/><span>{{TradingVolume ? TradingVolume : wdAll.TradingVolume }}</span></p>
            </div>
            <div class="chart-title-right">
              <div>
